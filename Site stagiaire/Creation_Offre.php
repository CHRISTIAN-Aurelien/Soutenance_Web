<?php
    ...
    if(isset($_POST))
    {
        if(isset($_POST['titre']) && !empty($_POST['titre']) && isset($_POST['descri']) && !empty($_POST['descri']) && isset($_POST['skills']) && !empty($_POST['skills']) && isset($_POST['duree']) && !empty($_POST['duree']) && isset($_POST['remuneration']) && !empty($_POST['remuneration']) && isset($_POST['embauche']) && !empty($_POST['embauche']) && isset($_POST['places']) && !empty($_POST['places'])) 
        {
            ...
            $sql = "INSERT INTO `internship` (`TITLE`, `DESCRIPTION`, `SKILLS`, `DURATION`, `REMUNERATION`, `OFFER_DATE`, `PLACES_NUMBER`) VALUES (:titre, :descri, :skills, :duree, :remuneration, :embauche, :places);";
...
<body id="main">
    ...
    <div id="uppercreaetudiant">
        <h2 id="titrepage">Création d'une offre</h2>
        ...
        <div class="container-md">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" aria-label="Sizing example input"
                    aria-describedby="inputGroup-sizing-default" id="titre" name="titre">
            </div>

            <div class="input-group mb-3">
                <span class="input-group-text" id="inputGroup-sizing-default">Description</span>
                <input type="text" class="form-control" aria-label="Sizing example input"
                    aria-describedby="inputGroup-sizing-default" id="descri" name="descri">
            </div>

            <h3 class="titreformulaire">Contenu</h3>

            <div class="input-group mb-3">
                <span class="input-group-text" id="inputGroup-sizing-default">Skills recquis (merci de les séparer par une virgule)</span>
                <input type="text" class="form-control" aria-label="Sizing example input"
                    aria-describedby="inputGroup-sizing-default" id="skills" name="skills">
            </div>

            <div class="input-group mb-3">
                <span class="input-group-text" id="inputGroup-sizing-default">Durée du stage</span>
                <input type="text" class="form-control" aria-label="Sizing example input"
                    aria-describedby="inputGroup-sizing-default" id="duree" name="duree">
            </div>

            <div class="input-group mb-3">
                <span class="input-group-text" id="inputGroup-sizing-default">Rémunération</span>
                <input type="text" class="form-control" aria-label="Sizing example input"
                    aria-describedby="inputGroup-sizing-default" id="remuneration" name="remuneration">
            </div>

            <div class="input-group mb-3">
                <span class="input-group-text" id="inputGroup-sizing-default">Date d'embauche sous format (aaaa-mm-jj)</span>
                <input type="text" class="form-control" aria-label="Sizing example input"
                    aria-describedby="inputGroup-sizing-default" id="embauche" name="embauche">
            </div>

            <div class="input-group mb-3">
                <span class="input-group-text" id="inputGroup-sizing-default">Nombre de places disponibles</span>
                <input type="text" class="form-control" aria-label="Sizing example input"
                    aria-describedby="inputGroup-sizing-default" id="places" name="places">
            </div>
