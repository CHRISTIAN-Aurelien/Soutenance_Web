<?php
    ...
    if(isset($_POST))
    {
        if(isset($_POST['nomentreprise']) && !empty($_POST['nomentreprise']) && isset($_POST['description']) && !empty($_POST['description']) && isset($_POST['secteur']) && !empty($_POST['secteur']) && isset($_POST['numinterne']) && !empty($_POST['numinterne'])) 
        {
            ...
            $sql = "INSERT INTO `company` (`COMPANY_NAME`,`DESCRIPTION`,`SECTOR`,`INTERN_NUMBER`) VALUES (:nomentreprise, :description, :secteur, :numinterne);";
...
<body id="main">
    ...
    <div id="uppercreaetudiant">
        <h2 id="titrepage">Création d'une entreprise</h2>
        ...
        <div class="container-md">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" aria-label="Sizing example input"
                    aria-describedby="inputGroup-sizing-default" id="nomentreprise" name="nomentreprise">
            </div>

            <div class="input-group mb-3">
                <span class="input-group-text" id="inputGroup-sizing-default">Description de l'entreprise</span>
                <input type="text" class="form-control" aria-label="Sizing example input"
                    aria-describedby="inputGroup-sizing-default" id="description" name="description">
            </div>
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" aria-label="Sizing example input"
                    aria-describedby="inputGroup-sizing-default" id="secteur" name="secteur">
            </div>

            <div class="input-group mb-3">
                <span class="input-group-text" id="inputGroup-sizing-default">Numéro interne</span>
                <input type="text" class="form-control" aria-label="Sizing example input"
                    aria-describedby="inputGroup-sizing-default" id="numinterne" name="numinterne">
            </div>
