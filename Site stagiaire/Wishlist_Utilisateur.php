...
<body id="main">
    ...
    <?php
        ...
        $identifiant = $data['ID_PERSON'];
        // On écrit notre requête
        $sql = "SELECT * 
        from wish
        inner join internship, locality, company
        where internship.ID_OFFERS = wish.ID_OFFERS && internship.ID_LOCALITY=locality.ID_LOCALITY && locality.ID_COMPANY=company.ID_COMPANY && wish.ID_PERSON = '$identifiant';";
        ...
        <table class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th scope="col">Retirer de la Wishlist</th>
                </tr>
            </thead>
            <tbody>
                <?php
                ...
                <tr>
                    ...
                    <td><button type="button" class="btn btn-outline-danger" onclick="self.location.href='Requete_Wishlist_2.php?id=<?= $produit['ID_OFFERS'] ?>.php'">Retirer de la wishlist</button></td>
                </tr>
                <?php
                    }
                ?>
