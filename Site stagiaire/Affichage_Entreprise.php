...
<body id="main">
    ...
    <div class="container-lg">
        <h4>Informations concernants l'entreprise</h4>
        <p>- Nom de l'entreprise : <?= $produit['COMPANY_NAME'] ?></p>
        <p>- Description de l'entreprise : <?= $produit['DESCRIPTION'] ?></p>
        <p>- Secteur : <?= $produit['SECTOR'] ?></p>
        <p>- Numéro interne : <?= $produit['INTERN_NUMBER'] ?></p>
    </div>
