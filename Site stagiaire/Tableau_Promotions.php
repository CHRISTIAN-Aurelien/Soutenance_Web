...
<body id="main">
    ...
    <div id="upper">
        <h2 id="titrepage">Récapitulatif des promotions</h2>
        <button type="button" class="btn btn-dark" onclick="self.location.href='Creation_Promotions.php'">Créer une nouvelle promotion</button>
    </div>
    ...
    <div class="container-lg">
        <table class="table table-striped">
            <thead>
                <tr>
                    <th scope="col">Nom des promotions</th>
            ...
            <tbody>
                ...
                ?>
                <tr>
                    <td><?= $produit['PROMOTION_NAME'] ?></td>
                    <td><button type="button" class="btn btn-outline-primary" onclick="self.location.href='Affichage_Promotions.php?id=<?= $produit['ID_PROMOTIONS'] ?>.php'">Afficher</button></td>
                    <td><button type="button" class="btn btn-outline-success" onclick="self.location.href='Modification_Promotions.php?id=<?= $produit['ID_PROMOTIONS'] ?>.php'">Modifier</button></td>
                    <td><button type="button" class="btn btn-outline-danger" onclick="self.location.href='Suppression_Promotions.php?id=<?= $produit['ID_PROMOTIONS'] ?>.php'">Supprimer</button></td>                 
                </tr>
                <?php
                    }
                ?>
