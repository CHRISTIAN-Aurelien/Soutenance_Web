...
if(isset($_GET['id']) && !empty($_GET['id'])){
    ...
    $sql = 'SELECT * 
    FROM promotions 
    WHERE promotions.ID_PROMOTIONS=:id;';
...
<body id="main">
    ...
    <!-- Contenu de la page -->
    <div id="upper">
        <h2 id="titrepage">Affichage d'une promotion</h2>
    ...
    <div class="container-lg">
        <h4>Informations concernants la promotion</h4>
        <p>- Nom de la promotion : <?= $produit['PROMOTION_NAME'] ?></p>
    </div>
