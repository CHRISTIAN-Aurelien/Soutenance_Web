...
<body id="main">
    ...
    <div id="upper">
        <h2 id="titrepage">Récapitulatif des offres</h2>
        <button type="button" class="btn btn-dark" onclick="self.location.href='Creation_Offre.php'">Créer une nouvelle offre</button>
    </div>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $produit['SKILLS'] ?></td>
                    <td><?= $produit['DURATION'] ?></td>
                    <td><?= $produit['REMUNERATION'] ?></td>
                    <td><?= $produit['OFFER_DATE'] ?></td>
                    <td><?= $produit['PLACES_NUMBER'] ?></td>
                    <td><button type="button" class="btn btn-outline-primary" onclick="self.location.href='Affichage_Offre.php?id=<?= $produit['ID_OFFERS'] ?>.php'">Afficher</button></td>
                    <td><button type="button" class="btn btn-outline-success" onclick="self.location.href='Modification_Offre.php?id=<?= $produit['ID_OFFERS'] ?>.php'">Modifier</button></td>
                    <td><button type="button" class="btn btn-outline-danger" onclick="self.location.href='Suppression_Offre.php?id=<?= $produit['ID_OFFERS'] ?>.php'">Supprimer</button></td>                 
                </tr>
                <?php
                    }
                ?>
