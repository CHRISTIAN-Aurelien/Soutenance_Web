<?php
    ...
    if(isset($_POST))
    {
        if(isset($_POST['id']) && !empty($_POST['id']) && isset($_POST['nomentreprise']) && !empty($_POST['nomentreprise']) && isset($_POST['description']) && !empty($_POST['description']) && isset($_POST['secteur']) && !empty($_POST['secteur']) && isset($_POST['numinterne']) && !empty($_POST['numinterne'])){
              
            $id = strip_tags($_GET['id']);
            $nomentreprise = strip_tags($_POST['nomentreprise']);
            $description = strip_tags($_POST['description']);
            $secteur = strip_tags($_POST['secteur']);
            $numinterne = strip_tags($_POST['numinterne']);

            $sql = "UPDATE `company` SET `COMPANY_NAME`=:nomentreprise, `DESCRIPTION`=:description, `SECTOR`=:secteur, `INTERN_NUMBER`=:numinterne WHERE `ID_COMPANY`=:id;";
            ...
            $query->bindValue(':numinterne', $numinterne, PDO::PARAM_STR);
...
<body id="main">
    ...
    <div id="uppercreaetudiant">
        <h2 id="titrepage">Modification d'une entreprise</h2>
        <button type="button" class="btn btn-dark" onclick="self.location.href='Tableau_Entreprise.php'"><i class="bi bi-arrow-left"></i> Retour au tableau</button>
    </div>


    <form method="post">
        <div class="container-md">
            <h3 class="titreformulaire">Descriptif de l'entreprise</h3>

            <div class="input-group mb-3">
                <span class="input-group-text" id="inputGroup-sizing-default">Nom de l'entreprise</span>
                <input type="text" class="form-control" aria-label="Sizing example input"
                    aria-describedby="inputGroup-sizing-default" id="nomentreprise" name="nomentreprise" value="<?= $result['COMPANY_NAME'] ?>">
            </div>

            <div class="input-group mb-3">
                <span class="input-group-text" id="inputGroup-sizing-default">Description de l'entreprise</span>
                <input type="text" class="form-control" aria-label="Sizing example input"
                    aria-describedby="inputGroup-sizing-default" id="description" name="description" value="<?= $result['DESCRIPTION'] ?>">
            </div>
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" aria-label="Sizing example input"
                    aria-describedby="inputGroup-sizing-default" id="secteur" name="secteur" value="<?= $result['SECTOR'] ?>">
            </div>

            <div class="input-group mb-3">
                <span class="input-group-text" id="inputGroup-sizing-default">Numéro interne</span>
                <input type="text" class="form-control" aria-label="Sizing example input"
                    aria-describedby="inputGroup-sizing-default" id="numinterne" name="numinterne" value="<?= $result['INTERN_NUMBER'] ?>">
            </div>
