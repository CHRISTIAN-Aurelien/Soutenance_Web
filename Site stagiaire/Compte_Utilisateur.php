...
<body id="main">
    ...
    <div id="uppercreaetudiant">
        <h2 id="titrepage">Compte Utilisateur</h2>
        <button type="button" class="btn btn-dark" onclick="self.location.href='Accueil.php'"><i class="bi bi-arrow-left"></i> Retour à l'accueil</button>
    </div>

    <div class="container-md">
        <h3 class="titreformulaire">Informations</h3>

        <p>Nom de famille : <?php print_r($data['LAST_NAME']);?> </p>
        <p>Prénom : <?php print_r($data['FIRST_NAME']);?></p>
        <p>Centre : <?php print_r($data['CENTER']); ?></p>
        <p>Promotions : <?php print_r($data['PROMOTION_NAME']);?></p>
        <p>Role : <?php print_r($data['Name_ROLE']);?></p>
    </div>
