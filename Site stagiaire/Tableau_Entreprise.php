...
<body id="main">
    ...
    <div id="upper">
        <h2 id="titrepage">Récapitulatif des entreprises</h2>
        <button type="button" class="btn btn-dark" onclick="self.location.href='Creation_Entreprise.php'">Créer une nouvelle entreprise</button>
    </div>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $produit['SECTOR'] ?></td>
                    <td><?= $produit['INTERN_NUMBER'] ?></td>
                    <td><button type="button" class="btn btn-outline-primary" onclick="self.location.href='Affichage_Entreprise.php?id=<?= $produit['ID_COMPANY'] ?>.php'">Afficher</button></td>
                    <td><button type="button" class="btn btn-outline-success" onclick="self.location.href='Modification_Entreprise.php?id=<?= $produit['ID_COMPANY'] ?>.php'">Modifier</button></td>
                    <td><button type="button" class="btn btn-outline-danger" onclick="self.location.href='Suppression_Entreprise.php?id=<?= $produit['ID_COMPANY'] ?>.php'">Supprimer</button></td>                 
                <?php
                    }
                ?>
            </tbody>
