...
<body id="main">
    ...
    <!-- Contenu de la page -->
    <div id="upperauthen">
        <h2 id="titrepage">Authentification</h2>
        <p id="legendetitre">Accéder à votre compte</p>
    </div>

    <div class="container">
        <div class="row justify-content-around">
          <div class="col" id="partiegauche">
            <h3>Se connecter à votre compte</h3>
            <p>Bienvenue sur la page de connexion</p>
          </div>
          <div class="col" id="partiedroite">

            <form method="post" action="Back_Authentification.php" onsubmit="required()">
                ...
                <button type="submit" class="btn btn-outline-dark" id="boutonconnection">Se connecter</button>
            </form>
