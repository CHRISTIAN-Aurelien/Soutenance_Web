...
<body id="main">
    ...
    <div id="uppercreaetudiant">
        <h2 id="titrepage">Gestion des permissions délégué</h2>
        <p id="legendetitre">Modification des permissions</p>
    </div>
    <form name="form3" method="POST" action="Requete_Gestion_Droit.php" onsubmit="required()">
    <div class="container-md">
        <h3 class="titreformulaire">Informations personnelles</h3>

        <div class="input-group mb-3">
        <label class="input-group-text" for="inputGroupSelect01" >Search a student account</label>
            <select class="form-select" id="inputGroupSelect01" name = "SSA">
        ...
        <div class="input-group mb-3">
        <label class="input-group-text" for="inputGroupSelect01" >Create a student account</label>
            <select class="form-select" id="inputGroupSelect01" name = "CSA">
                <option value="0">0</option>
                <option value="1">1</option>
            </select>
        </div>
        ...
        <div class="input-group mb-3">
        <label class="input-group-text" for="inputGroupSelect01" >Update a student account</label>
            <select class="form-select" id="inputGroupSelect01" name = "USA">
                <option value="0">0</option>
                <option value="1">1</option>
            </select>
        </div>
        ...
        <div class="input-group mb-3">
        <label class="input-group-text" for="inputGroupSelect01" >Delete a student account</label>
            <select class="form-select" id="inputGroupSelect01" name = "DSA">
                <option value="0">0</option>
                <option value="1">1</option>
            </select>
        </div>
        ...
        <div class="input-group mb-3">
            <label class="input-group-text" for="inputGroupSelect01" >Select stats of a student</label>
            <select class="form-select" id="inputGroupSelect01" name = "SS">
                <option value="0">0</option>
                <option value="1">1</option>
            </select>
        </div>
        ...
        <div class="input-group mb-3">
        <label class="input-group-text" for="inputGroupSelect01" >Search a pilot account</label>
            <select class="form-select" id="inputGroupSelect01" name = "SPA">
                <option value="0">0</option>
                <option value="1">1</option>
            </select>
        </div>
        ...
        <div class="input-group mb-3">
        <label class="input-group-text" for="inputGroupSelect01" >Create a pilot account</label>
            <select class="form-select" id="inputGroupSelect01" name = "CPA">
                <option value="0">0</option>
                <option value="1">1</option>
            </select>
        </div>
        ...
        <div class="input-group mb-3">
        <label class="input-group-text" for="inputGroupSelect01" >Update a pilot account</label>
            <select class="form-select" id="inputGroupSelect01" name = "UPA">
                <option value="0">0</option>
                <option value="1">1</option>
            </select>
        </div>
        ...
        <div class="input-group mb-3">
        <label class="input-group-text" for="inputGroupSelect01" >Delete a pilot account</label>
            <select class="form-select" id="inputGroupSelect01" name = "DPA">
                <option value="0">0</option>
                <option value="1">1</option>
            </select>
        </div>
        ...
        <div class="input-group mb-3">
            <label class="input-group-text" for="inputGroupSelect01" >Search delegate account</label>
            <select class="form-select" id="inputGroupSelect01" name = "SDA">
                <option value="0">0</option>
                <option value="1">1</option>
            </select>
        </div>
        ...
        <div class="input-group mb-3">
            <label class="input-group-text" for="inputGroupSelect01" >Create delegate account</label>
            <select class="form-select" id="inputGroupSelect01" name = "CDA">
                <option value="0">0</option>
                <option value="1">1</option>
            </select>
        </div>
        ...
        <div class="input-group mb-3">
            <label class="input-group-text" for="inputGroupSelect01" >Update delegate account</label>
            <select class="form-select" id="inputGroupSelect01" name = "UDA">
                <option value="0">0</option>
                <option value="1">1</option>
            </select>
        </div>
        ...
        <div class="input-group mb-3">
            <label class="input-group-text" for="inputGroupSelect01" >Delete delegate account</label>
            <select class="form-select" id="inputGroupSelect01" name = "DDA">
                <option value="0">0</option>
                <option value="1">1</option>
            </select>
        </div>
        ...
        <div class="input-group mb-3">
        <label class="input-group-text" for="inputGroupSelect01" >Search a company account</label>
            <select class="form-select" id="inputGroupSelect01" name = "SCA">
                <option value="0">0</option>
                <option value="1">1</option>
            </select>
        </div>
        ...
        <div class="input-group mb-3">
        <label class="input-group-text" for="inputGroupSelect01" >Create a company account</label>
            <select class="form-select" id="inputGroupSelect01" name = "CCA">
                <option value="0">0</option>
                <option value="1">1</option>
            </select>
        </div>
        ...
        <div class="input-group mb-3">
        <label class="input-group-text" for="inputGroupSelect01" >Update a company account</label>
            <select class="form-select" id="inputGroupSelect01" name = "UCA">
                <option value="0">0</option>
                <option value="1">1</option>
            </select>
        </div>
        ...
        <div class="input-group mb-3">
        <label class="input-group-text" for="inputGroupSelect01" >Delete a company account</label>
            <select class="form-select" id="inputGroupSelect01" name = "DCA">
                <option value="0">0</option>
                <option value="1">1</option>
            </select>
        </div>
        ...
        <div class="input-group mb-3">
        <label class="input-group-text" for="inputGroupSelect01" >Evaluate a company</label>
            <select class="form-select" id="inputGroupSelect01" name = "EC">
                <option value="0">0</option>
                <option value="1">1</option>
            </select>
        </div>
        ...
        <div class="input-group mb-3">
            <label class="input-group-text" for="inputGroupSelect01" >Select stats of company</label>
            <select class="form-select" id="inputGroupSelect01" name = "SSC">
                <option value="0">0</option>
                <option value="1">1</option>
            </select>
        </div>
        ...
        <div class="input-group mb-3">
            <label class="input-group-text" for="inputGroupSelect01" >Search offers</label>
            <select class="form-select" id="inputGroupSelect01" name = "SO">
                <option value="0">0</option>
                <option value="1">1</option>
            </select>
        </div>
        ...
        <div class="input-group mb-3">
            <label class="input-group-text" for="inputGroupSelect01" >Create offers</label>
            <select class="form-select" id="inputGroupSelect01" name = "CO">
                <option value="0">0</option>
                <option value="1">1</option>
            </select>
        </div>
        ...
        <div class="input-group mb-3">
            <label class="input-group-text" for="inputGroupSelect01" >Update offers</label>
            <select class="form-select" id="inputGroupSelect01" name = "UO">
                <option value="0">0</option>
                <option value="1">1</option>
            </select>
        </div>
        ...
        <div class="input-group mb-3">
            <label class="input-group-text" for="inputGroupSelect01" >Delete offers</label>
            <select class="form-select" id="inputGroupSelect01" name = "DO">
                <option value="0">0</option>
                <option value="1">1</option>
            </select>
        </div>
        ...
        <div class="input-group mb-3">
            <label class="input-group-text" for="inputGroupSelect01" >Select stats of an offer</label>
            <select class="form-select" id="inputGroupSelect01" name = "SSO">
                <option value="0">0</option>
                <option value="1">1</option>
            </select>
        </div>
        ...
        <div class="input-group mb-3">
            <label class="input-group-text" for="inputGroupSelect01" >Add offers to the wishlist</label>
            <select class="form-select" id="inputGroupSelect01" name = "AOW">
                <option value="0">0</option>
                <option value="1">1</option>
            </select>
        </div>
        ...
        <div class="input-group mb-3">
            <label class="input-group-text" for="inputGroupSelect01" >Remove offers from the wishlist</label>
            <select class="form-select" id="inputGroupSelect01" name = "DOW">
                <option value="0">0</option>
                <option value="1">1</option>
            </select>
        </div>
        ...
        <div class="input-group mb-3">
            <label class="input-group-text" for="inputGroupSelect01" >Apply to an offer</label>
            <select class="form-select" id="inputGroupSelect01" name = "AO">
                <option value="0">0</option>
                <option value="1">1</option>
            </select>
        </div>
        ...
        <div class="input-group mb-3">
            <label class="input-group-text" for="inputGroupSelect01" >Statut step 3</label>
            <select class="form-select" id="inputGroupSelect01" name = "SS3">
                <option value="0">0</option>
                <option value="1">1</option>
            </select>
        </div>
        ...
        <div class="input-group mb-3">
            <label class="input-group-text" for="inputGroupSelect01" >Statut step 4</label>
            <select class="form-select" id="inputGroupSelect01" name = "SS4">
                <option value="0">0</option>
                <option value="1">1</option>
            </select>
        </div>
