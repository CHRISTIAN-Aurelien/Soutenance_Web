...
<body id="main">
    ...
    <!-- Contenu de la page -->
    <div id="upper">
        <h2 id="titrepage">Affichage d'un utilisateur</h2>
    ...
    <div class="container-lg">
        <h4>Informations concernants l'utilisateur</h4>
        <p>- Nom de famille : <?= $produit['LAST_NAME'] ?></p>
        <p>- Prénom : <?= $produit['FIRST_NAME'] ?></p>
        <p>- Centre : <?= $produit['CENTER'] ?></p>
