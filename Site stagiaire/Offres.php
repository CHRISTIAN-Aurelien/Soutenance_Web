...
<body id="main">
    ...
    <?php
        ...
        $sql = 'SELECT * 
        from internship
        inner join locality, company
        where internship.ID_LOCALITY=locality.ID_LOCALITY && locality.ID_COMPANY=company.ID_COMPANY;';
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><button type="button" class="btn btn-outline-danger" onclick="self.location.href='Requete_Wishlist.php?id=<?= $produit['ID_OFFERS'] ?>.php'">Ajouter à la wishlist</button></td>
                    <td><button type="button" class="btn btn-outline-primary" onclick="self.location.href='Postuler.php?id=<?= $produit['ID_OFFERS'] ?>.php'">Postuler à l'offre</button></td>
                </tr>
                <?php
                    }
                ?>
