...
<body id="main">
    ...
    <div id="upper">
        <h2 id="titrepage">À propos</h2>
    </div>

    <div class="container-lg">
        <h3>Utilisation des Cookies</h3> 
        <p>L'utilisation d'un site internet implique de respecter les obligations liées à la protection des données personnelles des internautes.
...
Au besoin, existence d'un transfert des données personnelles vers un pays n'appartenant pas à l'Union européenne</p>
    </div>