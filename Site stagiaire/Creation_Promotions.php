<?php
    ...
    if(isset($_POST))
    {
        ...
        {
            $produit = strip_tags($_POST['promotion']);

            $sql = "INSERT INTO `promotions` (`PROMOTION_NAME`) VALUES (:promotion);";

            $query = $bdd->prepare($sql);

            $query->bindValue(':promotion', $produit, PDO::PARAM_STR);
...
<body id="main">
    ...
    <div id="uppercreaetudiant">
        <h2 id="titrepage">Création d'une promotion</h2>
        ...
        <div class="container-md">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" aria-label="Sizing example input"
                    aria-describedby="inputGroup-sizing-default" id="promotion" name="promotion">
            </div>
