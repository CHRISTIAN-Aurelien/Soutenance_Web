<?php
    ...
    if(isset($_POST))
    {
        ...
        {              
            ...
            $sql = "UPDATE `locality` SET `CITY`=:ville, `POSTAL_CODE`=:cp, `STREET`=:voie, `NUMBER`=:numero WHERE `ID_LOCALITY`=:id;";
    ...
    {
        $id = strip_tags($_GET['id']);
        $sql = "SELECT * FROM `locality` WHERE `ID_LOCALITY`=:id;";
        $query = $bdd->prepare($sql);
        $query->bindValue(':id', $id, PDO::PARAM_INT);
        $query->execute();
        ...
        <div class="container-md">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" aria-label="Sizing example input"
                    aria-describedby="inputGroup-sizing-default" id="ville" name="ville" value="<?= $result['CITY'] ?>">
            </div>

            <div class="input-group mb-3">
                <span class="input-group-text" id="inputGroup-sizing-default">Code postal</span>
                <input type="text" class="form-control" aria-label="Sizing example input"
                    aria-describedby="inputGroup-sizing-default" id="cp" name="cp" value="<?= $result['POSTAL_CODE'] ?>">
            </div>

            <div class="input-group mb-3">
                <span class="input-group-text" id="inputGroup-sizing-default">Nom de la voie</span>
                <input type="text" class="form-control" aria-label="Sizing example input"
                    aria-describedby="inputGroup-sizing-default" id="voie" name="voie" value="<?= $result['STREET'] ?>">
            </div>

            <div class="input-group mb-3">
                <span class="input-group-text" id="inputGroup-sizing-default">Numéro</span>
                <input type="text" class="form-control" aria-label="Sizing example input"
                    aria-describedby="inputGroup-sizing-default" id="numero" name="numero" value="<?= $result['NUMBER'] ?>">
            </div>
