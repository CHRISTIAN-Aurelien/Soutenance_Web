<?php
    ...
    if(isset($_POST))
    {
        if(isset($_POST['nom']) && !empty($_POST['nom']) && isset($_POST['prenom']) && !empty($_POST['prenom']) && isset($_POST['centre']) && !empty($_POST['centre']) && isset($_POST['logs']) && !empty($_POST['logs']) && isset($_POST['mdp']) && !empty($_POST['mdp'])){
            ...
            $sql = "UPDATE `user` SET `LAST_NAME`=:nom, `FIRST_NAME`=:prenom, `CENTER`=:centre, `LOGIN`=:logs, `PASSWORD`=:mdp WHERE `ID_PERSON`=:id;";
    ...
    {
        $id = strip_tags($_GET['id']);
        $sql = "SELECT * FROM `user` WHERE `ID_PERSON`=:id;";
        $query = $bdd->prepare($sql);
        $query->bindValue(':id', $id, PDO::PARAM_INT);
        $query->execute();
    ...
    <form method="post">
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" aria-label="Sizing example input"
                aria-describedby="inputGroup-sizing-default" id="nom" name="nom" value="<?= $result['LAST_NAME'] ?>">
        </div>

        <div class="input-group mb-3">
            <span class="input-group-text" id="inputGroup-sizing-default">Prénom</span>
            <input type="text" class="form-control" aria-label="Sizing example input"
                aria-describedby="inputGroup-sizing-default" id="prenom" name="prenom" value="<?= $result['FIRST_NAME'] ?>">
        </div>
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" aria-label="Sizing example input"
                aria-describedby="inputGroup-sizing-default" id="centre" name="centre" value="<?= $result['CENTER'] ?>"> 
        </div>
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" aria-label="Sizing example input"
                aria-describedby="inputGroup-sizing-default" id="logs" name="logs" value="<?= $result['LOGIN'] ?>">
        </div>

        <div class="input-group mb-3">
            <span class="input-group-text" id="inputGroup-sizing-default">Mot de passe</span>
            <input type="text" class="form-control" aria-label="Sizing example input"
                aria-describedby="inputGroup-sizing-default" id="mdp" name="mdp" value="<?= $result['PASSWORD'] ?>">
        </div>
