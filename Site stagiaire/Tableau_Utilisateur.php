...
<body id="main">
    ...
    <div id="upper">
        <h2 id="titrepage">Récapitulatif des utilisateurs</h2>
        <button type="button" class="btn btn-dark" onclick="self.location.href='Creation_Utilisateur.php'">Créer un nouvel utilisateur</button>
    </div>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $produit['CENTER'] ?></td>
                    <td><button type="button" class="btn btn-outline-primary" onclick="self.location.href='Affichage_Utilisateur.php?id=<?= $produit['ID_PERSON'] ?>.php'">Afficher</button></td>
                    <td><button type="button" class="btn btn-outline-success" onclick="self.location.href='Modification_Utilisateur.php?id=<?= $produit['ID_PERSON'] ?>.php'">Modifier</button></td>
                    <td><button type="button" class="btn btn-outline-danger" onclick="self.location.href='Suppression_Utilisateur.php?id=<?= $produit['ID_PERSON'] ?>.php'">Supprimer</button></td>                 
                </tr>
                <?php
                    }
                ?>
